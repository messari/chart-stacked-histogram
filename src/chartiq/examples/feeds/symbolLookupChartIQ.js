...
(function(definition) {
  ...
  if (typeof exports === 'object' && typeof module === 'object') {
    ...
    throw new Error(
      'Only CommonJS, RequireJS, and <script> tags supported for symbolLookupChartIQ.js.',
    );
  }
})(function(_exports) {
   ...
   *
   * Inherits all of the base Driver Lookup's properties via {@link CIQ.inheritsFrom}
   * @name ChartIQ
   * @memberof CIQ.ChartEngine.Driver.Lookup
   * @private
   * @since 6.0.0

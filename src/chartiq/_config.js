...
import { quoteFeedSimulator as quoteFeed } from './quoteFeedSimulator';
...
export function getDefaultConfig() {
  return {
    ...
    menuDisplay: [
      ...
      {
        label: 'Point & Figure',
        action: "Layout.ChartType('pandf')",
        option: "Layout.showAggregationEdit('pandf')",
        type: 'radio',
      },
      { type: 'separator' },
      ...
      },
      {
        ...
        action: 'Layout.ExtendedHours()',
        type: 'checkbox',
        required: 'ExtendedHours',
      },
      {
      ...
      // Layout.MarketDepth() binds and sets chart engine layout marketDepth propery that can be observed to initiat L2 data streaming
      {
        ...
        type: 'checkbox',
        required: 'cryptoiq',
      }, // absence of required resource will hide menu item until available
